...
const ActiveLink = styled(Link)(({ theme, active }) => ({
  ...theme.typography.body2,
  padding: theme.spacing(1),
  color: active === "active" ? "blue" : "#000",
  textDecoration: "none",
}));

function MaterialUIDrawer(props) {
    ...
    <div>
      ...
      <List>
        {[
          ...
          <ActiveLink
            href={`/campaigns/edit/${text.link}`}
            key={text.name}
            active={url == text.link ? "active" : ""}
          >
            <ListItem button>
              <ListItemIcon>
  ...
  const drawerTitle = (string = "basics") =>
